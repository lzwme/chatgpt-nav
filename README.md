...
1. [[⭐] https://chat.06.chat](https://chat.06.chat) ChatGPT API Demo `[error][200]Hello World!`
...
1. [[⭐] https://chat.caoayu.top](https://chat.caoayu.top) GPT3.5 Turbo `[error][-1]timeout`
...
1. [[⭐] https://chat.luoyangshusheng.com](https://chat.luoyangshusheng.com) ChatGPT API Demo `[error][-1]timeout`
...
1. [[⭐] https://chat.moyunav.com](https://chat.moyunav.com) ChatGPT `[error][403]Forbidden`
...
1. [[⭐] https://chat2.oroe.cn](https://chat2.oroe.cn) 羽化’s   ChatGPT API Demo
...
1. [[⭐] https://gpt5.life](https://gpt5.life)  `[error][404]Not Found`
...
1. [[⭐] https://hi.icu](https://hi.icu) https://hi.icu 中文ChatGPT `[error][400]default_vip_400`
...
1. [[⭐] https://www.fssflyang.icu](https://www.fssflyang.icu) ChatGPT `[error][200]const { spawn } = require('child_process');
...
module.exports = async (req, res) => {
  ...
  // 设置 PHP 程序的路径和参数
  const scriptPath = path.join(__dirname, 'api.php');
...
1. [[⭐] https://www.gpt5.life](https://www.gpt5.life) ChatGPT `[error][404]Not Found`
...
1. [[⭐] https://www.jianhua2017.top](https://www.jianhua2017.top) My API Demo
...
1. [[⭐] https://www.xianchen.xyz](https://www.xianchen.xyz)
...
1. [[⭐] https://xianchen.xyz](https://xianchen.xyz) ChatGPT
...
1. [[🚀] https://chatgpt-vercel-fssflyang.vercel.app](https://chatgpt-vercel-fssflyang.vercel.app) ChatGPT `[error][200]const { spawn } = require('child_process');
const path = require('path');
...
1. [[🚀] https://xjy-chat.vercel.app](https://xjy-chat.vercel.app) ChatGPT
...
1. [[❓] https://chat.forchange.cn](https://chat.forchange.cn)  `[error][-1]timeout`
...
1. [[❓] https://ai.chilfish.top](https://ai.chilfish.top) ChilGPT `[error][400]Bad Request`
...
1. [[❓] https://chat.kurox.cn](https://chat.kurox.cn) ChatGPT Demo `[error][403]Forbidden`
...
1. [[❓] https://ai.yougan.cc](https://ai.yougan.cc) ChatGPT API `[error][-1]connect ECONNREFUSED 122.10.85.4:443`
1. [[❓] https://chatgpt.curlybrackets.space](https://chatgpt.curlybrackets.space) ChatGPT API Demo `[error][-1]timeout`
1. [[❓🔑] https://chat.hswmartin.top](https://chat.hswmartin.top) ChatGPT API `[error][-1]timeout`
...
1. [[❓] https://chat.cblueu.cn](https://chat.cblueu.cn) ChatGPT Web `[error][-1]socket hang up`
...
1. [[❓] https://chat.kollykolly.cn](https://chat.kollykolly.cn) ChatGPT中文版 `[error][-1]socket hang up`
...
1. [[❓] https://chat.laijiahao.cn](https://chat.laijiahao.cn) [error][-1]write EPROTO C0D7BCB35D7F0000:error:0A00010B:SSL routines:ssl3_get_record:wrong version number:../deps/openssl/openssl/ssl/record/ssl3_record.c:355:
 `[error][-1]write EPROTO C0972323AB7F0000:error:0A00010B:SSL routines:ssl3_get_record:wrong version number:../deps/openssl/openssl/ssl/record/ssl3_record.c:355:
`
...
1. [[❓🚀] https://chatgpt-demo-roan.vercel.app](https://chatgpt-demo-roan.vercel.app)  `[error][404]Not Found`
...
1. [[❓] https://sumei2.guidaodeng.com](https://sumei2.guidaodeng.com)  `[error][404]Not Found`
