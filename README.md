...
1. [[⭐] https://lwray.top](https://lwray.top)  `[error][-1]connect ENETUNREACH 2a03:2880:f12d:83:face:b00c:0:25de:443 - Local (:::0)`
...
1. [[❓] https://t.chate.chat](https://t.chate.chat) **ChatGPT。**  `[error][-1]connect ECONNREFUSED 31.13.95.38:443`
...
1. [[❓] https://www.gpt.kendeji.fun](https://www.gpt.kendeji.fun) **ChatGPT。**  `[error][404]Not Found`
...
1. [[❓] https://chat.asurepos.com](https://chat.asurepos.com) **ChatGPT Next Web。**  `[error][-1]write EPROTO C0771131DE7F0000:error:0A000410:SSL routines:ssl3_read_bytes:sslv3 alert handshake failure:../deps/openssl/openssl/ssl/record/rec_layer_s3.c:1586:SSL alert number 40
`
...
1. [[❓] https://www.ztule.com](https://www.ztule.com) **ChatGPT。**  `[error][400]Bad Request`
...
1. [[❓] https://simpletrying.xyz](https://simpletrying.xyz)  `[error][-1]read ECONNRESET`
...
1. [[❓] https://chatgpt.zzgoodqc.cn](https://chatgpt.zzgoodqc.cn) **ChatGPT。**  `[error][-1]socket hang up`
