...
1. [[⭐⭐🧑‍💻] https://www.gptbot.icu](https://www.gptbot.icu) **ChatGPT。** 网站密码关注公众号：Maynor学长 回复“密码”获取 `[error][-1]connect ECONNREFUSED 154.85.102.30:443`
...
1. [[⭐] https://chat.slouch.top](https://chat.slouch.top) **ChatGPT Next Web。**  `[error][400]Bad Request`
...
1. [[⭐] https://chatmi.vip](https://chatmi.vip)  `[error][-1]connect ENETUNREACH 2a03:2880:f10e:83:face:b00c:0:25de:443 - Local (:::0)`
...
1. [[⭐] https://darmau.media](https://darmau.media) **ChatGPT Next Web。**  `[error][400]default_vip_400`
...
1. [[⭐] https://gptjerry.cloud](https://gptjerry.cloud)  `[error][-1]timeout`
...
1. [[⭐] https://lwray.top](https://lwray.top)  `[error][-1]timeout`
...
1. [[⭐] https://www.pongniwei.top](https://www.pongniwei.top) **ChatGPT Next Web。**  `[error][-1]read ECONNRESET`
...
1. [[⭐] https://www.sotai.cc](https://www.sotai.cc) **ChatGPT。**  `[error][400]Bad Request`
...
1. [[❓] https://chat.openai-proxy.com](https://chat.openai-proxy.com) **ChatGPT Next Web。**  `[error][-1]connect ECONNREFUSED 103.246.246.144:443`
...
1. [[❓🔐🔑] https://chat.tanyuecn.com](https://chat.tanyuecn.com) **ChatGPT Next Web。**  `[error][-1]write EPROTO C077E8F7B77F0000:error:0A000458:SSL routines:ssl3_read_bytes:tlsv1 unrecognized name:../deps/openssl/openssl/ssl/record/rec_layer_s3.c:1605:SSL alert number 112
`
