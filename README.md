...
由于众所周知的原因，国内访问并体验 ChatGPT 的拥有一定的门槛，主要集中在网络无法访问、账号无法注册两个限制条件。然而对于突破该约束条件的同学来说，则可以很轻松的使用开源应用搭建基于 OPENAI API 的在线体验网站。

本仓库旨在通过搜集整理国内用户可访问的在线体验列表，以供有需要的同学参考使用。其主要来源为：
