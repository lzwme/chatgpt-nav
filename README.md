...
1. [[⭐] https://www.gptcc.cc](https://www.gptcc.cc) **ChatGPT API Demo。**  `[error][-1]read ECONNRESET`
...
1. [[🔐🔑] https://chat.thatcoder.cn](https://chat.thatcoder.cn) **ChatGPT Next Web。**  `[error][403]Forbidden`
...
1. [[❓] https://bot.abc123.site](https://bot.abc123.site) **ChatGPT API Demo。**  `[error][400]Bad Request`
...
1. [[❓] https://chat.asurepos.com](https://chat.asurepos.com) **ChatGPT Next Web。**  `[error][-1]write EPROTO C09799F0797F0000:error:0A000410:SSL routines:ssl3_read_bytes:sslv3 alert handshake failure:../deps/openssl/openssl/ssl/record/rec_layer_s3.c:1586:SSL alert number 40
`
...
1. [[❓] https://chat1.lumione.cloud](https://chat1.lumione.cloud) **ChatGPT Next Web。**  `[error][-1]read ECONNRESET`
...
1. [[❌] https://www.alexsay.top](https://www.alexsay.top)  `[error][404]Not Found`
