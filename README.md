...
1. [[⭐] https://ai.chatmi.vip](https://ai.chatmi.vip) **大咪的ChatGPT。**  `[error][400]default_vip_400`
...
1. [[⭐] https://chat.caoayu.top](https://chat.caoayu.top) **GPT3.5 Turbo。**  `[error][-1]read ECONNRESET`
...
1. [[⭐⭐🚀] http://20200.cn](http://20200.cn) **AIGPT。**  `[error][-1]connect ENETUNREACH 2a03:2880:f12c:183:face:b00c:0:25de:80 - Local (:::0)`
...
1. [[❓] https://www.gptjerry.cloud](https://www.gptjerry.cloud) **ChatGPT Next Web。**  `[error][404]Not Found`
