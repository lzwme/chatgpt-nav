...
1. [[⭐⭐⭐🧑‍💻] https://ai-maas.wair.ac.cn](https://ai-maas.wair.ac.cn) **【大厂】紫东太初。** 中科院自动化所和武汉人工智能研究院联合推出的新一代大模型，从三模态走向全模态，支持多轮问答、文本创作、图像生成、3D理解、信号分析等全面问答任务，拥有更强的认知、理解、创作能力，带来全新互动体验。
...
1. [[⭐⭐⭐] https://chat.sensetime.com](https://chat.sensetime.com) **【大厂】商汤商量。** 商汤旗下的AI对话助手
...
1. [[⭐⭐⭐🧑‍💻] https://hunyuan.tencent.com](https://hunyuan.tencent.com) **【大厂】混元助手。** 腾讯混元助手Chat
1. [[⭐⭐⭐🧑‍💻] https://image.hunyuan.tencent.com](https://image.hunyuan.tencent.com) **【大厂】混元生图。** 腾讯混元生图
1. [[⭐⭐⭐] https://immersivetranslate.com](https://immersivetranslate.com) **沉浸式翻译。** 沉浸式翻译是一款免费的，好用的，没有废话的，革命性的，饱受赞誉的，AI 驱动的双语网页翻译扩展。
1. [[⭐⭐⭐🧑‍💻] https://kimi.moonshot.cn](https://kimi.moonshot.cn) **【大厂】 Kimi 智能助手。** Kimi智能助手能够支持约20万汉字的上下文输入，具备显著的中文优势，能够为用户提供回答问题、速读文件、整理资料、激发灵感、辅助创作等服务
...
1. [[⭐⭐⭐] https://qianwen.aliyun.com](https://qianwen.aliyun.com) **【大厂】通义千问。** 阿里达摩院提供的一个不断进化的AI大模型
...
1. [[⭐⭐⭐] https://tongyi.aliyun.com](https://tongyi.aliyun.com) **通义千问。** 阿里大模型统一品牌，覆盖语言、听觉、多模态等领域，致力于实现接近人类智慧的通用智能。
...
1. [[⭐⭐⭐] https://www.doubao.com](https://www.doubao.com) **豆包。** 字节旗下AI智能助手，可以新建个性化的智能体角色
1. [[⭐⭐⭐] https://www.doubao.com/chat](https://www.doubao.com/chat) **【大厂】豆包。** 基于字节跳动研发的云雀大语言模型的Chat应用
...
1. [[⭐⭐⭐🧑‍💻] https://xinghuo.xfyun.cn](https://xinghuo.xfyun.cn) **【大厂】讯飞星火认知大模型。** 讯飞星火大模型
...
1. [[⭐] https://agentgpt.reworkd.ai](https://agentgpt.reworkd.ai) **AgentGPT。** AgentGPT是一个革命性的基于浏览器的自主AI平台。 `[error][-1]timeout`
...
1. [[⭐] https://app.myshell.ai](https://app.myshell.ai) **Myshell。** MyShell是一个创新的聊天机器人平台，你可以在这里遇到各种拥有独特个性和声音的虚拟角色存在。作为创建者，你可以赋予你的聊天机器人一个非常生动的声音，并整合任何知识，超越现有的基于LLM的系统。 `[error][-1]timeout`
...
1. [[⭐] https://beta.character.ai](https://beta.character.ai) **Character AI。** 创建虚拟角色，并与其进行开放式对话。 `[error][-1]timeout`
...
1. [[⭐] https://bigesj.com/ai-ppt/?hmmd=youshe](https://bigesj.com/ai-ppt/?hmmd=youshe) **比格AI PPT。** 高效的AI PPT生成工具，一键生成大纲、智能排版设计。
1. [[⭐] https://bigjpg.com](https://bigjpg.com) **Bigjpg。** AI图片在线无损放大
1. [[⭐] https://blogs.microsoft.com/blog/2023/03/16/introducing-microsoft-365-copilot-your-copilot-for-work](https://blogs.microsoft.com/blog/2023/03/16/introducing-microsoft-365-copilot-your-copilot-for-work) **Microsoft 365 Copilot。** 暂未开放！内置GPT-4的微软Office
...
1. [[⭐] https://chatdoc.com](https://chatdoc.com) **chatDOC。** 通过与文档对话,以引用来源的方式获得即时答案。 `[error][-1]timeout`
1. [[⭐] https://chatexcel.com](https://chatexcel.com) **酷表 ChatExcel。** 酷表ChatExcel是通过文字聊天实现Excel的交互控制的AI辅助工具，期望通过对表输入需求即可得到处理后的数据。
1. [[⭐] https://chatpdf.com](https://chatpdf.com) **chatPDF。** 加入数百万学生、研究人员和专业人士的行列，通过 AI 即时回答问题。 `[error][-1]timeout`
...
1. [[⭐] https://clipdrop.co](https://clipdrop.co) **Watermark Remover。** 体验图像编辑的顶峰——水印移除AI，借助先进的人工智能技术轻松、精确地擦除水印，确保您的视觉效果保持完美清晰、无干扰。 `[error][-1]timeout`
1. [[⭐] https://clipdrop.co/stable-diffusion](https://clipdrop.co/stable-diffusion) **CanvaAi。** Canva的免费AI绘画工具
...
1. [[⭐] https://crypto.com/product-news/crypto-com-continues-ambitious-product-and-service-rollout-with-new-pioneering-innovation](https://crypto.com/product-news/crypto-com-continues-ambitious-product-and-service-rollout-with-new-pioneering-innovation) **Amy by Crypto。** 【金融】 `[error][-1]timeout`
...
1. [[⭐] https://designer.microsoft.com](https://designer.microsoft.com) **Microsoft Designer。** 微软推出的AI平面设计工具，实现快速完成设计加工
...
1. [[⭐] https://fanyi.caiyunapp.com](https://fanyi.caiyunapp.com) **彩云小译。** 彩云小译提供高效准确的在线翻译工具，包括文字翻译、文档翻译、网页翻译、术语库、浏览器插件和双语对照服务。
1. [[⭐] https://fanyi.caiyunapp.com/#](https://fanyi.caiyunapp.com/#) **彩云小译。** 推荐！兼具“你边说，我边译”的字字幕翻译功能
...
1. [[⭐] https://fanyi.youdao.com/index.html#](https://fanyi.youdao.com/index.html#) **有道翻译。** 网易旗下深受用户喜欢的口碑型学习工具产品
...
1. [[⭐] https://flowgpt.com](https://flowgpt.com) **Flowgpt。** 推荐！专注于分享聊天指令的社区网站
...
1. [[⭐] https://getgetai.com/workstation?from=youshe](https://getgetai.com/workstation?from=youshe) **字语未来。** 用AI创造更有价值的信息，定义新一代智能办公平台
...
1. [[⭐] https://github.com/tldraw/make-real](https://github.com/tldraw/make-real) **Makereal Tldraw。** 使用！通过草图生成可交互的UI界面和代码
...
1. [[⭐] https://hiwaifu.com](https://hiwaifu.com) **Hi Waifu。** Hi Waifu可以创建一个拥有独特个性的数字朋友，随时可以与AI聊天，准备好以一种新的方式与AI交流互动吧。 `[error][403]Forbidden`
1. [[⭐] https://hix.ai](https://hix.ai) **HIX.AI。** HIX.AI是一款由先进的GPT-3.5/4技术驱动的全能人工智能写作助手。 `[error][403]Forbidden`
...
1. [[⭐] https://janitorai.com](https://janitorai.com) **JanitorAI。** Janitor AI是由janitorai.com开发的一个平台，允许用户创建具有不同个性的虚拟聊天机器人角色。该平台由大型语言模型驱动，包括OpenAI的GPT模型。 `[error][403]Forbidden`
...
1. [[⭐] https://kuaiyi.wps.cn/txt-translate](https://kuaiyi.wps.cn/txt-translate) **金山快译。** 金山旗下多场景的翻译服务
...
1. [[⭐] https://lumalabs.ai](https://lumalabs.ai) **Luma Labs。** 推荐！将视频转为游戏资产
...
1. [[⭐] https://merlin.foyer.work](https://merlin.foyer.work) **Merlin。** Merlin是Open AI的ChatGPT驱动的Chrome扩展程序，随时随地可用。 `[error][-1]timeout`
...
1. [[⭐] https://monica.im](https://monica.im) **Moncia。** Monica是由ChatGPT API提供支持的Chrome扩展程序，旨在成为您的个人AI助手，实现轻松聊天和文案编写。 `[error][-1]timeout`
...
1. [[⭐] https://mymoss.com.cn/web](https://mymoss.com.cn/web) **MyMOSS。** 我拥有强大的AI引擎，可以辅助你快速写作，赶快试一试吧！
...
1. [[⭐] https://novelai.net](https://novelai.net) **Novel.ai。** 基于人工智能，轻松构建独特的、惊险的、引入入胜的故事。 `[error][-1]timeout`
...
1. [[⭐] https://pensoulai.com/index?share=youshe](https://pensoulai.com/index?share=youshe) **IPensoul。** 超好用的AI图片工具！提供建筑家居草图渲染，AI抠图等功能
1. [[⭐] https://picwish.com](https://picwish.com) **PicWish。** 这是一个免费的平台，可以为您的图片制作透明背景。一键去除背景，秒速合成透明照片。PicWish提供所有功能均免费。立即上传您的图片免费尝试！
1. [[⭐] https://pixai.art](https://pixai.art) **PixAI.Art。** 使用 PixAI 的AI艺术生成器释放创造力。轻松生成高品质的动漫人工智能艺术。探索 AI 工具、角色模板等。 `[error][-1]timeout`
...
1. [[⭐] https://pixlr.com/cn](https://pixlr.com/cn) **Pixlr。** Pixlr是一家提供基于云的照片编辑服务的供应商，为消费者和公司在浏览器中提供编辑功能。Pixlr提供了一个平台，可以进行各种第三方集成。 `[error][-1]timeout`
...
1. [[⭐] https://playgroundai.com](https://playgroundai.com) **Playground Ai。** 图片编辑工具，按照您的想象编辑图片 `[error][-1]timeout`
1. [[⭐] https://plus.wxredcover.cn](https://plus.wxredcover.cn) **ChatGPT。**
1. [[⭐] https://poe.com](https://poe.com) **Poe。** 问答社区Quora建立的一个平台，集成了多个流行的聊天机器人。 `[error][-1]timeout`
...
1. [[⭐] https://promptalot.com](https://promptalot.com) **Promptalot。** 推荐！超好用的MJ提示词辅助插件
1. [[⭐] https://promptbase.com](https://promptbase.com) **PromptBase。** AI提示词交易网站
1. [[⭐] https://prompthero.com](https://prompthero.com) **PromptHero。** 推荐！最受欢迎的AI提示词网站
1. [[⭐] https://promptomania.com](https://promptomania.com) **PromptoMania。** MJ和SD提示词生成器
1. [[⭐] https://puaai.net](https://puaai.net) **Ymiai。** 快捷、高效的人工智能创作平台
...
1. [[⭐] https://qoqo.ai/index.html](https://qoqo.ai/index.html) **QoQo。** 推荐！AI快速创建用户旅程地图
1. [[⭐] https://quillbot.com](https://quillbot.com) **Quillbot。** QuillBot一款写作改写工具，能够帮助您让写作更好、更快、更聪明。我们的改写工具是免费且易于使用的，只需点击一下按钮，即可进行改写。 `[error][403]Forbidden`
1. [[⭐] https://quizlet.com](https://quizlet.com) **Q Chat。** 【教育】教育领域的人工智能导师 `[error][403]Forbidden`
...
1. [[⭐] https://search.tiangong.cn](https://search.tiangong.cn) **天工搜索。** 昆仑万维旗下的天工搜索引擎。
1. [[⭐] https://sight.youdao.com](https://sight.youdao.com) **网易见外。** 网易自营的智能转写翻译服务。
1. [[⭐] https://skybox.blockadelabs.com](https://skybox.blockadelabs.com) **Text to Skybox。** 推荐！AI生成360°无缝环境贴图
...
1. [[⭐] https://theb.ai](https://theb.ai) **TheB.AI。** TheB.AI是一款全能的人工智能平台。可以访问一系列创新的模型，涵盖先进的语言模型、强大的图像模型等等。 `[error][-1]timeout`
...
1. [[⭐] https://tongyi.aliyun.com/wanxiang](https://tongyi.aliyun.com/wanxiang) **阿里通义万相。** 通义万相是阿里云通义旗下的AI创意作画平台，可提供AI艺术创作，可支持文生图、图生图、涂鸦作画、虚拟模特、个人写真等多场景的图片创作能力。
1. [[⭐] https://tools.picsart.com](https://tools.picsart.com) **QuickTools By Picsart。** Picsart是全球最大的数字创作平台。其由人工智能驱动的工具使各个水平的创作者能够设计、编辑、绘制和分享照片和视频内容。 `[error][-1]timeout`
...
1. [[⭐] https://withpoly.com/browse/textures](https://withpoly.com/browse/textures) **Poly。** 根据文本生成3D材质
...
1. [[⭐] https://writesonic.com](https://writesonic.com) **writesonic。** Writesonic可以为博客、广告、电子邮件和网站快速生成已优化的免费原创内容。 `[error][-1]timeout`
...
1. [[⭐] https://www.aichatting.net](https://www.aichatting.net) **AI Chatting。** 创建虚拟角色，并与其进行开放式对话。 `[error][-1]timeout`
...
1. [[⭐] https://www.bing.com](https://www.bing.com) **Bing。** bing版ChatGPT聊天机器人，微软新搜索引擎。
1. [[⭐] https://www.bing.com/new](https://www.bing.com/new) **Bing。** Bing版ChatGPT聊天机器人，微软新搜索引擎
1. [[⭐] https://www.canva.com/ai-image-generator](https://www.canva.com/ai-image-generator) **Canva Text to Image。** 将文字和短语变成美丽的图片。 `[error][403]Forbidden`
1. [[⭐] https://www.capcut.cn](https://www.capcut.cn) **剪映专业版。** 强大的国产剪辑工具！支持AI智能生成字幕和配音
1. [[⭐] https://www.chai-research.com](https://www.chai-research.com) **Chai Research。** 领先的AI聊天平台 `[error][-1]timeout`
1. [[⭐] https://www.chat2ai.cn/khanacademy.org](https://www.chat2ai.cn/khanacademy.org) **Khanmigo。** 【教育】教育界的世界级人工智能。
...
1. [[⭐] https://www.craiyon.com](https://www.craiyon.com) **Craiyon。** 基于AI全新免费 AI 图像生成器。 `[error][-1]timeout`
1. [[⭐] https://www.creativefabrica.com/spark](https://www.creativefabrica.com/spark) **CF Spark。** Spark让您只需输入您的提示，就可以开始生成图片。平台目前已经拥有一个强大的社区，让您可以获得关注者和设计反馈。 `[error][-1]timeout`
1. [[⭐] https://www.cursor.so](https://www.cursor.so) **Cursor。** 基于GPT的代码生成工具
1. [[⭐] https://www.cutout.pro](https://www.cutout.pro) **Cutout Pro。** 全能视觉设计平台，包含 AI 照片和视频编辑工具。自动化背景移除、图像修复、平面设计等。 `[error][-1]timeout`
...
1. [[⭐] https://www.edrawsoft.cn/mindmaster](https://www.edrawsoft.cn/mindmaster) **亿图脑图。** 万兴科技旗下的亿图脑图MindMaster软件是一款多平台思维导图软件，可用于Windows，Mac和Linux等桌面环境，也可以在线使用或在苹果，安卓等移动端上使用。 `[error][301]Moved Permanently`
1. [[⭐] https://www.esheep.com](https://www.esheep.com) **eSheep。** 推荐！国内知名的开源AI模型社区
1. [[⭐] https://www.fotor.com/cn](https://www.fotor.com/cn) **Fotor。** Fotor是一款免费的在线照片编辑器，可以轻松编辑、裁剪、调整大小、添加效果和文字，创建拼贴等。 `[error][-1]timeout`
...
1. [[⭐] https://www.giiso.com](https://www.giiso.com) **Giiso写作机器人。** Giiso是一款内容创作AI辅助工具，提供资讯写作、小红书文案、短视频脚本、PPT创作、文生图等类型创作。 `[error][-1]read ECONNRESET`
...
1. [[⭐] https://www.phind.com](https://www.phind.com) **Phind。** 为开发人员而生的AI搜索引擎。 `[error][403]Forbidden`
...
1. [[⭐] https://www.promeai.com](https://www.promeai.com) **PromeAI。** 神采PromeAI拥有强大的人工智能驱动设计助手和广泛可控的AIGC（C-AIGC）模型风格库，使你能够轻松地创造出令人惊叹的图形、视频和动画。 `[error][-1]getaddrinfo ENOTFOUND www.promeai.com`
...
1. [[⭐] https://www.soulgen.net](https://www.soulgen.net) **SoulGen。** SoulGen 是一款 AI 魔法工具，可根据文本或提示创建令人惊叹的真实女孩艺术。立即免费试用并创建定制的 AI 角色。 `[error][403]Forbidden`
...
1. [[⭐] https://yinxiang.com/dl-mac](https://yinxiang.com/dl-mac) **印象 AI。** 「印象笔记」X「印象AI」会创作的第二大脑 `[error][301]Moved Permanently`
1. [[⭐] https://yodayo.com/text-to-image](https://yodayo.com/text-to-image) **Yodayo。** 探索人工智能生成的动漫艺术，找到最佳提示，使用我们的免费人工智能艺术生成器创建美丽的图像，并与其他动漫迷分享！ `[error][-1]timeout`
1. [[⭐] https://you.com](https://you.com) **You。** You是一种具有对话性和持续学习能力的技术，可以增强网络搜索、写作、编码、数字艺术创作和解决复杂问题。 `[error][-1]timeout`
...
1. [[🔑] https://chat-simplifier.imzbb.cc](https://chat-simplifier.imzbb.cc) **聊天简化器。** 聊天简化器
...
1. [[⭐⭐⭐🚀] https://deepmind.google/technologies/gemini](https://deepmind.google/technologies/gemini) **Gemini。** Gemini(双子座)是Google最新的大型语言模型，在一系列多模式基准测试中超越了最先进GPT4。在各种自然语言任务中表现良好，例如摘要、指令跟踪、内容生成、情感分析、实体提取、分类等。
